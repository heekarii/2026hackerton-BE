...
from models import Category, Complaint, ComplaintAttachment, ComplaintStatus, User
import schemas
...
def create_complaint(
    ...
    """민원 등록 엔드포인트. 작성자는 인증 토큰의 사용자이며, 상태는 기본값(received)으로 시작한다."""
